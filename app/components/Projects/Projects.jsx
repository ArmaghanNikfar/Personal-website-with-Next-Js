...
const Projects = () =>{
    ...
    <h1 className='mb-7'>Recent Projects</h1>
    <Grid container spacing={4}>
      <Grid item xs={6}>
        <Card className='card'>
          <img src='logo.ceb69b3c.svg' className='cardImage' />
          <CardContent>
      ...
      <Grid item xs={6}>
        <Card className='card'>
          <img src='logo.eac02f07.svg' className='cardImage' />
          <CardContent>
      ...
      <Grid item xs={6}>
        <Card className='card'>
          <h3 className='px-5 py-5 uppercase font-bold text-lg text-zinc-500 tracking-wide'>CAFE</h3>
          <CardContent>
